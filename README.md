...
- _의문점_:
  ...
  - 이유: 이번 앱의 목적이 데이터를 기반으로 한, "정해진 질문에 대한 올바른 답변하기" 입니다. 그러나, 예상 질문이 맥락을 기준으로 생성한다면, 생성된 예상 질문이 과연 쓸모가 있을지는 의문입니다.
...
- **이러한 아키텍처 및 기법을 혼합해서, 가장 정확하게 답변을 생성하는 아키텍처를 선별할 수 있음**
